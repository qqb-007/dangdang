...
<html>
	...
	<body>
		...
		<table width="80%" border="0" align="center" cellspacing="0" cellpadding="5">
			<tr>
				<td rowspan="9" width="20%" valign="top"><img src="${book.cover}" width="240px" height="340px" /></td>
		...
		<hr style="border:1px dotted #666"/>
		<h2>书摘插图</h2>
		<p>&nbsp;&nbsp;<img src="${book.cover}" width="240px" height="340px" /></p>
		<!--页尾开始 -->
