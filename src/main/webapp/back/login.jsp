...
<script type="text/javascript">
	function changeImage(){
		$("#imgVcode").attr("src","${pageContext.request.contextPath }/admin/code?id="+Math.random());
	}
</script>
</head>
<body>
								...
								<div class="Captcha-operate">
									<div class="Captcha-imageConatiner">
										<a class="code_pic" id="vcodeImgWrap" name="change_code_img" href="javascript:void(0);">
											<img id="imgVcode" src="${pageContext.request.contextPath }/admin/code" class="Ucc_captcha Captcha-image" onClick="changeImage()">
										</a>
