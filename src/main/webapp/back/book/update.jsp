...
<body style="background-color: #f0f9fd;text-align: center">
	...
	<hr />
	<div align="center">
	<form action="${pageContext.request.contextPath }/book/book_updateBook" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					          
					<td>名称：</td>
					<td>
					<input type="text" name="book.name" class="el-input__inner" value="${book.name }">
					<input type="hidden" name="book.id" value=${book.id }>
					<input type="hidden" name="book.sale" value=${book.sale }>
					<input type="hidden" name="book.createDate" value=${book.createDate }>
					<input type="hidden" name="book.cover" value=${book.cover }>
					</td>
					<td rowspan="14" style="width: 300px">
					<td>页数：</td>
					<td><input type="text" name="book.pageNum" class="el-input__inner" value="${book.pageNum }" ></td>
				</tr>
				<tr>
					<td>所属分类：</td>
					<td>
					...
					<td>字数：</td>
					<td><input type="text" name="book.wordNum" class="el-input__inner" value="${book.wordNum }" ></td>
				</tr>
				
				<tr>
					<td>原价：</td>
					<td><input type="text" name="book.price" class="el-input__inner" value="${book.price }"></td>
					<td>封面：</td>
					<td rowspan="3">
						<label id="file_upload1_label" for="file_upload1">
							<img id="uploadimg" src="${book.cover}" alt="" width="120" height="145" />
						</label> 
				...
				<tr>
					<td>当当价：</td>
					<td><input type='text' name="book.dprice" class="el-input__inner" value="${book.dprice }"></td>
					<td></td>
				</tr>
				<tr>
					<td>库存：</td>
				...
				<tr>
					<td>出版时间：</td>
					<td><input type="date" name="book.pressDate" class="el-input__inner" value="${book.pressDate}"></td>
					<td>内容简介：</td>
				...
				<tr>
					<td>印刷时间：</td>
					<td><input type="date" name="book.printDate" class="el-input__inner" value="${book.printDate }" /></td>
					<td>作者简介：</td>
