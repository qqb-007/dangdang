...
<body
	...
	<hr />
	<div align="center">
		<form action="${pageContext.request.contextPath }/book/book_addBook" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					<td>名称：</td>
				...
				<tr>
					<td>开本：</td>
					<td><input type="text" name="book.size" class="el-input__inner"></td>
					<td></td>
				</tr>
				<tr>
					<td>纸张：</td>
