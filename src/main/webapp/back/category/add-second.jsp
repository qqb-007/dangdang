...
<html>
  ...
  <body style="background-color: #f0f9fd;">
  	...
  	<form action="${pageContext.request.contextPath }/category/category_addScendCategory" method="get">
		所属一级类别:		
		...
		<c:forEach items="${requestScope.list}" var="category">
  		...
  		<br/><br/>
  		二级类别名:<input class="el-input__inner" type="text" name="sname" id="sname"/><br/><br/>
